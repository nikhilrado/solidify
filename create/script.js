...
window.addEventListener('load',function(){
	...
	password.addEventListener('focus', (event) => {
		...
		var URL = "https://api.solidify.ortanatech.com/action?action=upload-model&uuid="
...
function getCheckoutLink(shipping_countryf,obj_name){
	...
	var URL = "https://6jmccwuhpljudbczwm7uaheuzy0infif.lambda-url.us-east-2.on.aws/"
	fetch(URL,{
		headers: {
...
function pay(){
	...
	getCheckoutLink(document.getElementById('shipping').value,document.getElementById('o-name').value)
}
